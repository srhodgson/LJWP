...
public class Project {
    ...
    public void greetGuest() {
        ...
        String dinosaur = scanner.next();

        System.out.println("Hello " + name + " you're in for a treat, " + dinosaur + " is really looking forward to meeting you!");
    }
    ...
    public void checkVisitorsCount() {
        ...
        if (currentGuests >= maxGuests) {
            System.out.println("The park is currently full.");
        } else {
            System.out.println("The park is currently not full.");
        }
    }
